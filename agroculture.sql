...
ALTER TABLE farmer MODIFY fhash VARCHAR(255) DEFAULT 'default_value';

ALTER TABLE buyer ADD CONSTRAINT fk_bid FOREIGN KEY (bid) REFERENCES farmer(fid) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE mycart ADD COLUMN quantity INT NOT NULL DEFAULT 1;